...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self reloadData:tableView WithIndexPath:indexPath ];
 }

- (void) reloadData
{
    [super reloadData];
    [self reloadData:self WithIndexPath:[_SKSTableViewDelegate selectedIndex]];
}

- (void)reloadData:(UITableView *)tableView WithIndexPath:(NSIndexPath *)indexPath
{
