...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        if (IOS7)
        {
            ...
            self.stringLabel.attributedText = attrStr;
            ...
            [dic setObject:self.stringLabel.font forKey:NSFontAttributeName];
            
            // 计算文本的大小
            stringSize = [string boundingRectWithSize:CGSizeMake(210.0f, 50.0f) // 用于计算文本绘制时占据的矩形块
