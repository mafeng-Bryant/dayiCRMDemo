 ...
 * untouched.
 */
#define kILAlertViewTitleColor [UIColor blackColor]
#define kILAlertViewMessageColor [UIColor blackColor]
#define kILAlertViewCloseButtonColor [UIColor blueColor]
#define kILAlertViewCloseButtonColorSelected kILAlertViewTitleColor
#define kILAlertViewSecondButtonColor [UIColor blueColor]
...
- (ILAlertView *)initWithTitle:(NSString *)title
            ...
            tappedSecondButton:(void(^)(NSInteger))block
{
    self = [super init];
    ...
    if (self) {
        ...
        _bkgImg.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight;
        ...
        if (secondTitle) {
            ...
            //_secondButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
        ...
        //_closeButton.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
...
- (void)keyboardWillShow:(NSNotification *)notification{
    ...
    [UIView animateWithDuration:[[info objectForKey:UIKeyboardAnimationDurationUserInfoKey] doubleValue] animations:^{
        self.frame = CGRectMake(self.frame.origin.x, _window.frame.size.height - kbSize.height -self.frame.size.height-5.0f, self.frame.size.width, self.frame.size.height);
...
- (NSInteger)addButtonWithTitle:(NSString *)title {
    if (title) {
        _secondButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [_secondButton setTitle:title forState:UIControlStateNormal];
        [_secondButton setTitleColor:kILAlertViewSecondButtonColor forState:UIControlStateNormal];
        [_secondButton setTitleColor:kILAlertViewSecondButtonColorSelected forState:UIControlStateHighlighted];
        _secondButton.titleLabel.font = kILAlertViewButtonFont;
        _secondButton.tag = kSecondButtonTag;
